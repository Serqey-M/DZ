...
class ATM():
    ...
    def __init__(self, name: str, balance: float) -> None:
        ...
        with open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\\balance-{self.name}.txt', 'w', encoding='utf-8') as f1, \
            open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\count_operation-{self.name}.txt', 'w', encoding='utf-8') as f2:
            f1.write(str(self.balance))
            f2.write(str(0))
            

    def replenish(self):
        with open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\\balance-{self.name}.txt', 'r', encoding='utf-8') as f1, \
            open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\count_operation-{self.name}.txt', 'r', encoding='utf-8') as f2:
        ...
        with open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\\balance-{self.name}.txt', 'w', encoding='utf-8') as f1, \
            open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\count_operation-{self.name}.txt', 'w', encoding='utf-8') as f2, \
            open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\information.txt', 'a', encoding='utf-8') as f3:
        ...
        while operation != 0:
            ...
            match operation:
                ...
                case 2:
                    self.withdraw()
                case 3:
                    with open(f'D:\GB\ДЗ\Погружение в Python\ДЗ10\information.txt', "r", encoding='utf-8') as f:
                        print(list(f))
                case 0:
                    break
                case _:
