...
class Backpack():
    ...
    def __init__(self, things: dict, backpack_capacity: float) -> None:
        self.things = things
...
if __name__ == '__main__':
    ...
    backpack = Backpack(list_of_things, 7)
    print(backpack.filling_backpack())
    backpack.possible_backpack_fillings()
